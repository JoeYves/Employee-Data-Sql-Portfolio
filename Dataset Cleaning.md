...
<p><span style="font-size:16px;">First, saved the original copy of data as 'data_cleaning1.csv' </span></p>
...
<p><span style="font-size:16px;">We have to make sure that our dataset does not contain some repeatings data in its columns.</p>
...
<p><span style="font-size:16px;">they are 35 duplicates. they should be removed and save table.</span></p>
